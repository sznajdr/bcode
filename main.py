...
st.markdown("<iframe src='https://colab.research.google.com/drive/16l0hgwL2Mg-FkCQBiKBLIVj1IX6GsCrA?authuser=2#scrollTo=uXPh6wWK_oD0' width='100%' height='600'></iframe>", unsafe_allow_html=True)
